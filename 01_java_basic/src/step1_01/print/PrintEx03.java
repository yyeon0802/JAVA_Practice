...
public class PrintEx03 {
	...
	public static void main(String[] args) {
		...
		// google 자바 api > oracle 홈페이지에서 메뉴얼 열람 가능

		// 타임스탬프 현재 컴퓨터 시스템의 날짜와 시간을 얻어온다.
		Date date = new Date();
		...
		System.out.println("================================");
//		int time = System.currentTimeMillis();  에러발생 -> int(1억단위)가 가질수 있는 범위 넘어섬
		long time = System.currentTimeMillis(); // long -> 조단위
		...
		NumberFormat nf = NumberFormat.getNumberInstance(); // new안씀 static!
